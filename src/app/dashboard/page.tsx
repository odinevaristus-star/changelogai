      ...
      <div className="max-w-5xl mx-auto space-y-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <Button className="rounded-full" asChild>
            <Link href="/sync"><Plus className="w-4 h-4 mr-2" /> Sync New Repo</Link>
          </Button>
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <Button variant="outline" className="w-full justify-start rounded-xl h-12" asChild>
                <Link href="/generator"><Zap className="w-4 h-4 mr-3 text-primary" />Generate Release Notes</Link>
              </Button>
              <Button variant="outline" className="w-full justify-start rounded-xl h-12" asChild>
                <Link href="/timeline"><History className="w-4 h-4 mr-3 text-primary" />View Public Timeline</Link>
              </Button>
              <Button variant="outline" className="w-full justify-start rounded-xl h-12" asChild>
                <Link href="/sync"><GitBranch className="w-4 h-4 mr-3 text-primary" />Manage Connections</Link>
              </Button>
            </CardContent>
          </Card>
        </div>
